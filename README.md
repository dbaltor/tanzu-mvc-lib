...
<br>
7. Go back to the application and generate more data. You can follow some link to the lists and refresh the Browser multiple times. You will notice the same data will show up across all AIs (different background colors).
<p/>
<p/>
<b>Cleaning up:</b><br>
<hr>
